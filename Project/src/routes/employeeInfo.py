...
@route.post('/{employeeUid}', status_code=status.HTTP_201_CREATED , response_model=GetFullEmpInfoModel)
...
@route.patch('/{employeeUid}', status_code=status.HTTP_200_OK , response_model=GetFullEmpInfoModel)
